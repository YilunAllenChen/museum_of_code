                ...
                <div class="relative isolate px-6 pt-14 lg:px-8">
                    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 bg-opacity-50">
                        <div class="text-center">
                            <h1 class="text-4xl font-bold tracking-tight text-gray-100 sm:text-4xl">{"🚧Under Construction🚧"}</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-300">{"This Page is Still Under Construction. Check back later!"}</p>

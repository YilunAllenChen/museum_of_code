        ...
        if !self.show_sidebar {
            ...
            html! {
                ...
                <div class="fixed inset-0 z-50 w-screen overflow-y-auto">
                  <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0" onclick={
                    ctx.link().callback(|_| Msg::ToggleSidebar(false))
                  }>
                    <div class="enter-exit-bottom relative transform overflow-hidden rounded-lg bg-slate-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">

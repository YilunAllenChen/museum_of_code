                        ...
                        <div class="text-center">
                            ...
                            <div class="mt-10 flex items-center justify-center gap-x-6 mb-20">
                                ...
                                <a href="#"
                                    ...
                                    class="rounded-md disabled bg-green-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                    {"Contribute"}
                                </a>
                                <a href="#"
                                    onclick={ctx.props().on_clicked.reform(|_| "About".into())}
                                    class="rounded-md disabled bg-yellow-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-yellow-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                    {"About the Museum"}
                                </a>
                            </div>
                        </div>

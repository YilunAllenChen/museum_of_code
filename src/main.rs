              ...
              <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                  ...
                  <div class="mt-10 flex items-center justify-center gap-x-6 mb-8">
                    <a href="#" class="rounded-md disabled bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{"Take A Tour"}</a>
                ...
                <div class="bg-gray-800 lg:pl-20 text-gray-300 p-4  rounded-md justify-left items-left">
                    <pre><code class="text-sm font-mono text-left">{r#"
